<div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-md-7 col-sm-7">
                    <div class="form-group">
                      <img src="<?php echo base_url();?>assets/images/users/user.png" alt="" class="profile-photo-md" />
              ...
              <div class="post-content">
                ...
                <img src="<?php echo base_url();?>assets/images/post-images/12.jpg" alt="post-image" class="img-responsive post-image" />
                <div class="post-container">
                  ...
                  <div class="post-detail">
                    ...
                    <div class="post-text">
                      <p>I am a software devloper <i class="em em-anguished"></i> <i class="em em-anguished"></i> <i class="em em-anguished"></i></p>
                    </div>
                    <div class="line-divider"></div>
              ...
              <div class="post-content">
                ...
                <img src="<?php echo base_url();?>assets/images/post-images/13.jpg" alt="post-image" class="img-responsive post-image" />
                <div class="post-container">
                  <img src="<?php echo base_url();?>assets/images/users/user.png" alt="user" class="profile-photo-md pull-left" />
                  <div class="post-detail">
                    <div class="user-info">
                    ...
                    <div class="post-comment">
                      <img src="<?php echo base_url();?>assets/images/users/user.png" alt="" class="profile-photo-sm" />
                      <p><a href="<?php echo base_url();?>assets/timeline.html" class="profile-link">John</a> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud </p>
                    </div>
                    <div class="post-comment">
                      <img src="<?php echo base_url();?>assets/images/users/user.png" alt="" class="profile-photo-sm" />
                      <input type="text" class="form-control" placeholder="Post a comment">
              ...
              <div class="post-content">
                ...
                <div class="post-container">
                  ...
                  <div class="post-detail">
                    ...
                    <div class="line-divider"></div>
                    <div class="post-comment">
                      <img src="<?php echo base_url();?>assets/images/users/user-11.jpg" alt="" class="profile-photo-sm" />
                      <p><a href="timeline.html" class="profile-link">Diana </a><i class="em em-laughing"></i> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud </p>
                    </div>
                    <div class="post-comment">
                      <img src="<?php echo base_url();?>assets/images/users/user-4.jpg" alt="" class="profile-photo-sm" />
                      <p><a href="timeline.html" class="profile-link">John</a> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud </p>
                    </div>
                    <div class="post-comment">

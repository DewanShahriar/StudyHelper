...
<!-- Mirrored from themified.com/friend-finder/index-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Apr 2021 09:09:17 GMT -->
<head>
    ...
    <div id="lp-register">
        ...
        <div class="row">
            ...
            <div class="intro-texts">
            	<h1 class="text-white">Study Assistance!!!</h1>
            ...
            <div class="reg-form-container"> 
              ...
              <div class="reg-options">
                <ul class="nav nav-tabs">
                  <li class="<?php if($activeMenu === 'register') echo 'active';?>"><a href="#register" data-toggle="tab">Register</a></li>
                  <li class="<?php if($activeMenu === 'login') echo 'active';?>"><a href="#login" data-toggle="tab">Login</a></li>
                </ul><!--Tabs End-->
              </div>
              
              <!--Registration Form Contents-->
              <div class="tab-content">
                <div class="tab-pane <?php if($activeMenu === 'register') echo 'active';?>" id="register">
                  <h3>Register Now !!!</h3>
                  <p class="text-muted">Be cool and join today. Meet millions</p>
                  
                  <!--Register Form-->
                  <form action="<?php echo base_url()?>login/registration" method="POST" name="registration_form" id='registration_form' class="form-inline">
                    <div class="row">
                ...
                <!--Login-->
                <div class="tab-pane <?php if($activeMenu === 'login') echo 'active';?>" id="login">
                  <h3>Login</h3>
                  <p class="text-muted">Log into your account</p>
                  
                  <!--Login Form-->
                  <form action="<?php echo base_url()?>login/login-validation" method="POST" name="Login_form" id='Login_form'>
                     <div class="row">
                      <div class="form-group col-xs-12">
...
<!-- Mirrored from themified.com/friend-finder/index-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Apr 2021 09:09:34 GMT -->
</html>
